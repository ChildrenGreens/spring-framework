...
public abstract class NamespaceHandlerSupport implements NamespaceHandler {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		BeanDefinitionParser parser = findParserForElement(element, parserContext);// 获取解析类
	...
	private BeanDefinitionParser findParserForElement(Element element, ParserContext parserContext) {
		String localName = parserContext.getDelegate().getLocalName(element); // 获取标签命令空间名称
		BeanDefinitionParser parser = this.parsers.get(localName); // 从parses的Map对象中获取到解析类
		if (parser == null) {
